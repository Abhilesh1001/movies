...
import Img from "../ladyLoadImg/Img";
...
const Carousel = ({data,loading,endPoint,title}) => {
  ...
  return (
    <div className="carousel">
      ...
      <BsFillArrowLeftCircleFill className="carouselRightNav arrow" onClick={()=>navigation("right")} />
    {!loading?<div className="carouselItems" ref={carouselContainer}>{data?.map((item)=>{
